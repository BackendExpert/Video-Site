...
@section('content')
    <div class="admin-card">
        ...
        <a href="{{ url('videos/create') }}"><button class="btn btn-success"><i class="fas fa-video"></i> Add New Video</button></a>
        <a href="{{ url('videos/create') }}"><button class="btn btn-success"><i class="fas fa-video"></i> All Videos</button></a><br><br>
